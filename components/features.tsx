...
import FeaturesImage from "@/public/images/features-1.png";
import SectionHeader from "@/components/landing/molecules/SectionHeader";
  ...
  return (
    <section className="relative bg-bg">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t border-border py-12 md:py-20">
          {/* Section header */}
          <SectionHeader
            eyebrow="Key Features"
            title="Key Features"
            description="Everything you need to capture, prioritize, and execute with confidence."
            align="center"
            className="pb-4 md:pb-12"
          />
          <div className="flex justify-center pb-4 md:pb-12" data-aos="fade-up">
            <div className="rounded-xl border border-border bg-surface p-2 shadow-s1">
              <Image
                className="max-w-none scale-75"
                src={FeaturesImage}
                width={1104}
                height={384}
                alt="Features"
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <FeatureItem
              icon={
                <svg className="mb-3 fill-primary" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              title="Daily Todo Capture"
              description="Never miss tasks."
            />
            <FeatureItem
              icon={
                <svg className="mb-3 fill-ai" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
                  <path fillOpacity=".48" d="M7 8V0H5v8h2Zm12 16v-4h-2v4h2Z" />
                  <path d="M19 6H0v2h17v8H7v-6H5v8h19v-2h-5V6Z" />
                </svg>
              }
              title="AI Prioritize Ritual"
              description="Reorder tasks by urgency & impact."
            />
            <FeatureItem
              icon={
                <svg className="mb-3 fill-primary" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              title="Team Sync"
              description="Share todos across team & platforms instantly."
            />
            <FeatureItem
              icon={
                <svg className="mb-3 fill-ai" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
              ...
              description="AI-generated end-of-day status reports."
            />
            <FeatureItem
              icon={
                <svg className="mb-3 fill-primary" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
            ...
            <FeatureItem
              icon={
                <svg className="mb-3 fill-success" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
